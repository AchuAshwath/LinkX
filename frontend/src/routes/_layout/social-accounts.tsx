          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 sm:px-6">
            ...
            <div className="flex items-center gap-2 shrink-0 sm:self-center">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-88 p-2 text-xs space-y-2"
                >
                  <DropdownMenuLabel className="text-[11px] font-semibold text-foreground px-1 py-0.5">
                    Terminal Scripts
                  </DropdownMenuLabel>
                  <DropdownMenuSeparator />

                  {/* Script 1 */}
                  <div className="p-2 rounded-md bg-muted/60 border space-y-1">
                    <div className="flex items-center justify-between text-[11px] font-medium text-foreground">
                      <span>1. Headed Login</span>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-5 w-5 text-muted-foreground hover:text-foreground"
                    ...
                    <code className="text-primary font-mono text-[10px] block truncate select-all">
                      {headedLoginCmd}
                    </code>
                  </div>
